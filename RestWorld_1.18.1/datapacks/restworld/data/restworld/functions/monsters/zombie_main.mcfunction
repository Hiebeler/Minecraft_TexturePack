...
execute if score zombie funcs matches 0 run summon zombie ~0.2 ~2 ~0 {Tags:[zombie,zombieish,monsters,monsters_mobs],CustomName:"\"Zombie\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}

execute if score zombie_jockey funcs matches 1 run execute if score zombie funcs matches 0 run summon zombie ~0.2 ~2 ~0 {Tags:[zombie,zombieish,monsters,monsters_mobs],CustomName:"\"Zombie\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
...
execute if score zombie funcs matches 1 run summon husk ~0.2 ~2 ~0 {Tags:[husk,zombieish,monsters,monsters_mobs],CustomName:"\"Husk\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}

execute if score zombie_jockey funcs matches 1 run execute if score zombie funcs matches 1 run summon husk ~0.2 ~2 ~0 {Tags:[husk,zombieish,monsters,monsters_mobs],CustomName:"\"Husk\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
...
execute if score zombie funcs matches 2 run summon drowned ~0.2 ~2 ~0 {Tags:[drowned,zombieish,monsters,monsters_mobs],CustomName:"\"Drowned\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}

execute if score zombie_jockey funcs matches 1 run execute if score zombie funcs matches 2 run summon drowned ~0.2 ~2 ~0 {Tags:[drowned,zombieish,monsters,monsters_mobs],CustomName:"\"Drowned\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
