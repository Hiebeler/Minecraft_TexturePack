...
execute if score spiders funcs matches 0 run summon spider ~-0.2 ~2.5 ~-0.2 {Tags:[spiders,spider,monsters,monsters_mobs],CustomName:"\"Spider\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}

execute if score spiders funcs matches 0 run summon cave_spider ~-0.2 ~2.5 ~-2.7 {Tags:[spiders,cave_spider,monsters,monsters_mobs],CustomName:"\"Cave Spider\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}




execute if score spiders funcs matches 1 run summon spider ~-0.2 ~2.5 ~-0.2 {Tags:[spiders,spider,monsters,monsters_mobs],Passengers:[{id:"skeleton",Tags:[monsters],HandItems:[{id:"bow",Count:1b},{}],Rotation:[270f,0f],Facing:east,PersistenceRequired:True,NoAI:True,Silent:True}],CustomName:"\"Spider\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}

execute if score spiders funcs matches 1 run summon cave_spider ~-0.2 ~2.5 ~-2.7 {Tags:[spiders,cave_spider,monsters,monsters_mobs],Passengers:[{id:"skeleton",Tags:[monsters],HandItems:[{id:"bow",Count:1b},{}],Rotation:[270f,0f],Facing:east,PersistenceRequired:True,NoAI:True,Silent:True}],CustomName:"\"Cave Spider\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
