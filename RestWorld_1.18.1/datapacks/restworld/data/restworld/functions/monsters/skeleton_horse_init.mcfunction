...
summon skeleton_horse ~0.2 ~2 ~0 {Tags:[skeleton_horse,monsters,monsters_mobs],CustomName:"\"Skeleton Horse\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
