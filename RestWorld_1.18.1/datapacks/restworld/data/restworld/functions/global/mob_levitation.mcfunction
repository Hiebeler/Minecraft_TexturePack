...
execute if score mob_levitation funcs matches 1 run execute as @e[tag=friendlies_home] run execute at @s run tp @s ~0 ~2 ~0
...
execute if score mob_levitation funcs matches 1 run execute as @e[tag=monsters_home] run execute at @s run tp @s ~0 ~2 ~0
...
execute if score mob_levitation funcs matches 1 run execute as @e[tag=aquatic_home] run execute at @s run tp @s ~0 ~2 ~0
...
execute if score mob_levitation funcs matches 1 run execute as @e[tag=wither_home] run execute at @s run tp @s ~0 ~2 ~0
...
execute if score mob_levitation funcs matches 0 run execute as @e[tag=friendlies_home] run execute at @s run tp @s ~0 ~-2 ~0
...
execute if score mob_levitation funcs matches 0 run execute as @e[tag=monsters_home] run execute at @s run tp @s ~0 ~-2 ~0
...
execute if score mob_levitation funcs matches 0 run execute as @e[tag=aquatic_home] run execute at @s run tp @s ~0 ~-2 ~0
...
execute if score mob_levitation funcs matches 0 run execute as @e[tag=wither_home] run execute at @s run tp @s ~0 ~-2 ~0
