...
summon item_frame ~4 ~2 ~2 {Facing:2,Tags:[only_item_frame,only_item_frame_sculk_sensor]}


summon item_frame ~4 ~2 ~1 {Facing:2,Tags:[only_item_frame,only_item_frame_spawner]}
...
item replace block ~1 ~-5 ~-1 container.0 from entity @e[tag=only_item_frame_knowledge_book,limit=1] container.0
...
item replace block ~1 ~-5 ~-1 container.1 from entity @e[tag=only_item_frame_debug_stick,limit=1] container.0
...
item replace block ~1 ~-5 ~-1 container.2 from entity @e[tag=only_item_frame_suspicious_stew,limit=1] container.0
...
item replace block ~1 ~-5 ~-1 container.3 from entity @e[tag=only_item_frame_firework_star,limit=1] container.0


data merge entity @e[tag=only_item_frame_bundle,limit=1] {Item:{id:bundle,Count:1,tag:{display:{Name:'{"text":"Bundle"}'}}},Fixed:True}
item replace block ~1 ~-5 ~-1 container.4 from entity @e[tag=only_item_frame_bundle,limit=1] container.0


data merge entity @e[tag=only_item_frame_jigsaw,limit=1] {Item:{id:jigsaw,Count:1,tag:{display:{Name:'{"text":"Jigsaw"}'}}},Fixed:True}
item replace block ~1 ~-5 ~-1 container.5 from entity @e[tag=only_item_frame_jigsaw,limit=1] container.0
...
item replace block ~1 ~-5 ~-1 container.6 from entity @e[tag=only_item_frame_structure_block,limit=1] container.0
...
item replace block ~1 ~-5 ~-1 container.7 from entity @e[tag=only_item_frame_structure_void,limit=1] container.0


data merge entity @e[tag=only_item_frame_barrier,limit=1] {Item:{id:barrier,Count:1,tag:{display:{Name:'{"text":"Barrier"}'}}},Fixed:True}
item replace block ~1 ~-5 ~-1 container.8 from entity @e[tag=only_item_frame_barrier,limit=1] container.0


data merge entity @e[tag=only_item_frame_light,limit=1] {Item:{id:light,Count:1,tag:{display:{Name:'{"text":"Light"}'}}},Fixed:True}
item replace block ~1 ~-5 ~-1 container.9 from entity @e[tag=only_item_frame_light,limit=1] container.0
...
item replace block ~1 ~-5 ~-1 container.10 from entity @e[tag=only_item_frame_dragon_egg,limit=1] container.0
...
item replace block ~1 ~-5 ~-1 container.11 from entity @e[tag=only_item_frame_command_block,limit=1] container.0
...
item replace block ~1 ~-5 ~-1 container.12 from entity @e[tag=only_item_frame_command_block_minecart,limit=1] container.0


data merge entity @e[tag=only_item_frame_sculk_sensor,limit=1] {Item:{id:sculk_sensor,Count:1,tag:{display:{Name:'{"text":"Sculk Sensor"}'}}},Fixed:True}
item replace block ~1 ~-5 ~-1 container.13 from entity @e[tag=only_item_frame_sculk_sensor,limit=1] container.0


data merge entity @e[tag=only_item_frame_spawner,limit=1] {Item:{id:spawner,Count:1,tag:{display:{Name:'{"text":"Spawner"}'}}},Fixed:True}
item replace block ~1 ~-5 ~-1 container.14 from entity @e[tag=only_item_frame_spawner,limit=1] container.0
