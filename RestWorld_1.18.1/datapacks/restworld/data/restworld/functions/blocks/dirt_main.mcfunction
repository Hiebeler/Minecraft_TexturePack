...
execute unless score block_list funcs matches 0 unless entity @e[tag=block_list_dirt_0_0_0] run summon armor_stand ~0 ~3.2199999999999998 ~0 {Invisible:True,NoGravity:True,CustomNameVisible:True,Tags:[block_list,block_list_dirt,block_list_dirt_0_0_0]}
...
execute unless score block_list funcs matches 0 unless entity @e[tag=block_list_dirt_0_0_1] run summon armor_stand ~0 ~2.98 ~0 {Invisible:True,NoGravity:True,CustomNameVisible:True,Tags:[block_list,block_list_dirt,block_list_dirt_0_0_1]}
...
execute unless score block_list funcs matches 0 unless entity @e[tag=block_list_dirt_0_0_2] run summon armor_stand ~0 ~2.74 ~0 {Invisible:True,NoGravity:True,CustomNameVisible:True,Tags:[block_list,block_list_dirt,block_list_dirt_0_0_2]}
