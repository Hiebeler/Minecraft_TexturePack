...
scoreboard players set effects_all max 32
execute unless score effects_all funcs matches 0..31 run scoreboard players operation effects_all funcs %= effects_all max
