scoreboard players set trees max 6
execute unless score trees funcs matches 0..5 run scoreboard players operation trees funcs %= trees max
...
execute if score trees funcs matches 3 run data merge block ~-1 ~0 ~-1 {mode:"LOAD",name:"restworld:oak_trees"}
...
execute if score trees funcs matches 3 run setblock ~1 ~2 ~7 minecraft:oak_wall_sign[facing=west]{Text2:"\"Oak Trees\""} replace

execute if score trees funcs matches 4 run data merge block ~-1 ~0 ~-1 {mode:"LOAD",name:"restworld:dark_oak_trees"}
...
execute if score trees funcs matches 4 run setblock ~1 ~2 ~7 minecraft:oak_wall_sign[facing=west]{Text2:"\"Dark Oak Trees\""} replace

execute if score trees funcs matches 5 run data merge block ~-1 ~0 ~-1 {mode:"LOAD",name:"restworld:spruce_trees"}
...
execute if score trees funcs matches 5 run setblock ~1 ~2 ~7 minecraft:oak_wall_sign[facing=west]{Text2:"\"Spruce Trees\""} replace
