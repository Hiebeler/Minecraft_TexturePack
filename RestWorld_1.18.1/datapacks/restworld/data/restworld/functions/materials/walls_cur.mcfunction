scoreboard players set walls max 21
execute unless score walls funcs matches 0..20 run scoreboard players operation walls funcs %= walls max
...
execute if score walls funcs matches 17 run fill ~8 ~3 ~6 ~0 ~2 ~0 cobbled_deepslate_wall replace #restworld:fencelike
execute if score walls funcs matches 17 run data merge block ~5 ~2 ~0 {Text1:"\"\"",Text2:"\"Cobbled\"",Text3:"\"Deepslate Wall\"",Text4:"\"\""}



execute if score walls funcs matches 18 run fill ~8 ~3 ~6 ~0 ~2 ~0 polished_deepslate_wall replace #restworld:fencelike
execute if score walls funcs matches 18 run data merge block ~5 ~2 ~0 {Text1:"\"\"",Text2:"\"Polished\"",Text3:"\"Deepslate Wall\"",Text4:"\"\""}



execute if score walls funcs matches 19 run fill ~8 ~3 ~6 ~0 ~2 ~0 deepslate_brick_wall replace #restworld:fencelike
execute if score walls funcs matches 19 run data merge block ~5 ~2 ~0 {Text1:"\"\"",Text2:"\"Deepslate\"",Text3:"\"Brick Wall\"",Text4:"\"\""}



execute if score walls funcs matches 20 run fill ~8 ~3 ~6 ~0 ~2 ~0 deepslate_tile_wall replace #restworld:fencelike
execute if score walls funcs matches 20 run data merge block ~5 ~2 ~0 {Text1:"\"\"",Text2:"\"Deepslate\"",Text3:"\"Tile Wall\"",Text4:"\"\""}
