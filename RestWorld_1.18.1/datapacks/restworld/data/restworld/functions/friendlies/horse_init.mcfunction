...
summon horse ~-1.2 ~2 ~0 {Tags:[white_horses,horse,saddle,friendlies,friendlies_mobs],Variant:0,Tame:True,CustomName:"\"White\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
...
summon horse ~-1.2 ~2 ~-2 {Tags:[creamy_horses,horse,saddle,friendlies,friendlies_mobs],Variant:1,Tame:True,CustomName:"\"Creamy\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
...
summon horse ~-1.2 ~2 ~-4 {Tags:[chestnut_horses,horse,saddle,friendlies,friendlies_mobs],Variant:2,Tame:True,CustomName:"\"Chestnut\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
...
summon horse ~-1.2 ~2 ~-6 {Tags:[brown_horses,horse,saddle,friendlies,friendlies_mobs],Variant:3,Tame:True,CustomName:"\"Brown\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
...
summon horse ~-1.2 ~2 ~-8 {Tags:[black_horses,horse,saddle,friendlies,friendlies_mobs],Variant:4,Tame:True,CustomName:"\"Black\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
...
summon horse ~-1.2 ~2 ~-10 {Tags:[gray_horses,horse,saddle,friendlies,friendlies_mobs],Variant:5,Tame:True,CustomName:"\"Gray\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
...
summon horse ~-1.2 ~2 ~-12 {Tags:[dark_brown_horses,horse,saddle,friendlies,friendlies_mobs],Variant:6,Tame:True,CustomName:"\"Dark Brown\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
