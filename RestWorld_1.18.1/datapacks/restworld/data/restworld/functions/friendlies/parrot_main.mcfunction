execute unless score parrot funcs matches 0.. run function parrot_init
...
execute if score parrot funcs matches 0 run setblock ~0 ~2 ~1 oak_fence_gate
...
execute if score parrot funcs matches 1 run setblock ~0 ~2 ~1 air
...
execute if score parrot funcs matches 2 run setblock ~0 ~2 ~1 oak_fence_gate
...
execute if score parrot funcs matches 3 run setblock ~0 ~2 ~1 air
...
execute if score parrot funcs matches 4 run setblock ~0 ~2 ~1 oak_fence_gate
...
execute if score parrot funcs matches 5 run setblock ~0 ~2 ~1 air
...
execute if score parrot funcs matches 6 run setblock ~0 ~2 ~1 oak_fence_gate
...
execute if score parrot funcs matches 7 run setblock ~0 ~2 ~1 air
...
execute if score parrot funcs matches 8 run setblock ~0 ~2 ~1 oak_fence_gate
...
execute if score parrot funcs matches 9 run setblock ~0 ~2 ~1 air
