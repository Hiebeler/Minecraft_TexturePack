...
summon wolf ~0 ~2 ~-0.2 {Tags:[wolf,friendlies,friendlies_mobs],CustomName:"\"Wolf\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[0f,0f]}
...
summon wolf ~2 ~2 ~-0.2 {Tags:[collared,wolf,friendlies,friendlies_mobs],Owner:dummy,CustomName:"\"Dog\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[0f,0f]}
