...
execute if score cow funcs matches 0 run summon cow ~-1.2 ~2 ~0 {Tags:[cow,cowish,friendlies,friendlies_mobs],CustomName:"\"Cow\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
...
execute if score cow funcs matches 1 run summon mooshroom ~-1.2 ~2 ~0 {Tags:[mooshroom,cowish,friendlies,friendlies_mobs],CustomName:"\"MooShroom\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
...
execute if score cow funcs matches 2 run summon mooshroom ~-1.2 ~2 ~0 {Tags:[mooshroom,cowish,friendlies,friendlies_mobs],Type:brown,CustomName:"\"MooShroom\"",PersistenceRequired:True,NoAI:True,Silent:True,Rotation:[270f,0f]}
